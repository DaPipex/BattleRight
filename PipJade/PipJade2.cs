...
namespace PipJade
{
    internal static class PipJade2
    {
        ...
        private static void ComboMode()
        {
                ...
                switch (LastAbilityFired)
                {
                    case AbilitySlot.UltimateAbility:
                        if (M2_FTarget != null)
                        {
                            ...
                            var collisionObjects = CollisionFlags.InvisWalls | CollisionFlags.Bush;
            ...
            if (JadeMenu.GetBoolean("combo.useF") && MiscUtils.CanCast(AbilitySlot.UltimateAbility))
            {
            ...
            if (JadeMenu.GetBoolean("combo.useR") && MiscUtils.CanCast(AbilitySlot.EnergyAbility))
            {
            ...
            if (JadeMenu.GetBoolean("combo.useM1") && MiscUtils.CanCast(AbilitySlot.Ability1))
            {
                if (LastAbilityFired == null && M1Target != null)
                {
                    ...
                    {
                        LocalPlayer.UpdateCursorPosition(pred.MousePosition);
                        LocalPlayer.CastAbility(AbilitySlot.Ability1, 5);
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            if (JadeMenu.GetBoolean("draw.escapeSkillsScreen"))
            {
                ...
                Drawing.DrawString(drawSpacePos.ScreenToWorld(), textToDrawSpace, abilitySpaceReady ? UnityEngine.Color.green : UnityEngine.Color.red);
                ...
                Drawing.DrawString(drawQPos.ScreenToWorld(), textToDrawQ, abilitySpaceReady ? UnityEngine.Color.green : UnityEngine.Color.red);
            }
        }
    }
}
